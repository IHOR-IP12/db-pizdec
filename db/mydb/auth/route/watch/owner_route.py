...
@owner_bp.get('/<int:owner_id>/watches')
def find_watches_by_index(owner_id) -> Response:
    return make_response(jsonify(owner_controller.find_watches_by_index(owner_id)), HTTPStatus.OK)
