...
@watch_bp.get('/<int:watch_id>/notifications')
def get_all_notifications_from_watches(watch_id) -> Response:
    return make_response(jsonify(watch_controller.find_notifications(watch_id)), HTTPStatus.OK)
