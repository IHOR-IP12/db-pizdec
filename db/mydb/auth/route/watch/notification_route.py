...
@notification_bp.get('/<int:notification_id>/watches')
def get_all_notifications_from_watches(notification_id) -> Response:
    return make_response(jsonify(notification_controller.find_watches(notification_id)), HTTPStatus.OK)
